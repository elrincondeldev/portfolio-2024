      ...
      <main className="flex flex-col gap-16 max-w-[1200px] mx-10">
        ...
        <section className="flex md:hidden items-center justify-between">
          <div className="flex flex-col gap-10 items-center">
            <div className="flex flex-col gap-2">
              <h1 className="acorn-bold title text-4xl text-center">
                El Rincón Del Dev
              </h1>
              <h1 className="acorn-bold text-3xl text-center">
                Memes, resources, and now my exeriencies.
              </h1>
            </div>
          ...
          <div className="flex bg-[#FFFFFF] bg-opacity-[10%] justify-center rounded-2xl p-10 gap-8 w-[100%]">
            <div className="flex flex-col gap-8">
              <div className="flex flex-col gap-5">
                <a href="https://youtu.be/HUMCjQufH6s" target="_blank">
                  <Image
                    src="/Miniatura 1.png"
                    height={500}
                    width={500}
              ...
              <div className="flex flex-col gap-5">
                <a href="https://youtu.be/64pX_YwG7-Q" target="_blank">
                  <Image
                    src="/Miniatura 2.png"
                    height={500}
                    width={500}
            ...
            <div className="flex flex-col gap-8">
              <div className="flex flex-col gap-5">
                <a href="https://youtu.be/nUrIEXwOtIw" target="_blank">
                  <Image
                    src="/Miniatura 3.png"
                    height={500}
                    width={500}
              ...
              <div className="flex flex-col gap-5">
                <a href="https://youtu.be/tlW0HMghDrE" target="_blank">
                  <Image
                    src="/Miniatura 4.png"
                    height={500}
                    width={500}
